...
import HabitsStatsScreen from '../screens/HabitsStatsScreen';
...
function HabitsStackNavigator() {
  return (
    <HabitsStack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <HabitsStack.Screen name="HabitsGoals" component={HabitsGoalsScreen} />
      <HabitsStack.Screen name="HabitsStats" component={HabitsStatsScreen} />
...
function MainTabsNavigator() {
  ...
  return (
      ...
      screenOptions={({ route }) => ({
        ...
        tabBarIcon: ({ color, size }) => {
          ...
          switch (route.name) {
            ...
            // === NEW: habits tab icon ===
            case 'Habits':
              iconName = 'walk-outline'; // or 'checkbox-outline' / 'water-outline'
              break;
            case 'Timer':
              iconName = 'timer-outline';
              break;
    ...
    >
      ...
      <Tab.Screen name="Challenges" component={ChallengeStackNavigator} options={{ tabBarLabel: '' }} />
      <Tab.Screen name="Workouts" component={WorkoutStackNavigator} options={{ tabBarLabel: '' }} />
      <Tab.Screen name="StreakLeaderboard" component={StreakLeaderboardScreen} options={{ tabBarLabel: '' }} />
      {/* === NEW: Habits tab === */}
      <Tab.Screen name="Habits" component={HabitsStackNavigator} options={{ tabBarLabel: '' }} />
      <Tab.Screen name="Timer" component={TimerScreen} options={{ tabBarLabel: '' }} />
