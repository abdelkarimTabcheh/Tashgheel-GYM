...
import {
  ...
  IconButton, Tooltip, Snackbar, Alert, CircularProgress, Typography, Button, Chip
} from '@mui/material';
...
export default function Workouts() {
  ...
  return (
    <Box p={3}>
      <Typography variant="h4" mb={3}>Workouts Management</Typography>
              ...
              {workouts.map((w) => (
                <TableRow key={w._id}>
                  ...
                  <TableCell align="right">
                    <Tooltip title="Edit">
                      <IconButton color="primary" onClick={() => { setWorkoutToEdit(w); setEditDialogOpen(true); }}>
                        <EditIcon />
                      </IconButton>
                    </Tooltip>
                    <Tooltip title="Delete">
                      <IconButton color="error" onClick={() => { setWorkoutToDelete(w._id); setDeleteConfirmOpen(true); }}>
                        <DeleteIcon />
                      </IconButton>
                    </Tooltip>
                  </TableCell>
      ...
      {deleteConfirmOpen && (
        <Alert
          ...
          action={
            <>
              <Button color="inherit" size="small" onClick={() => setDeleteConfirmOpen(false)}>Cancel</Button>
              <Button color="inherit" size="small" onClick={handleDeleteConfirm}>Delete</Button>
            </>
          }
        >
